                  ...
                  {payments.map((p, i) => (
                    <div key={i} className="flex items-center justify-between p-3 bg-[#F5F5F7] rounded-xl text-sm">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="font-bold text-[#0071E3]">{p.amount.toFixed(2)}</span>
            ...
            {remaining > 0 ? (
              <div className="bg-white p-5 rounded-2xl border border-[#D2D2D7] shadow-sm space-y-4">
                ...
                <button
                  ...
                  className="w-full py-3 border-2 border-[#0071E3] text-[#0071E3] font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-[#0071E3]/5 transition-colors"
                >

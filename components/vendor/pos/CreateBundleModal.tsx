              ...
              {isLoading ? (
                ...
                filteredInventory.map((item: InventoryItem) => (
                  <div key={item.variant_id} className="flex items-center justify-between p-3 bg-white border border-[#F5F5F7] rounded-xl">
                    ...
                    <button onClick={() => addItem(item)} className="p-1.5 bg-[#0071E3]/10 text-[#0071E3] rounded-lg hover:bg-[#0071E3] hover:text-white transition-colors">
            ...
            <div className="pt-4 border-t border-[#D2D2D7] space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-white border border-[#0071E3] rounded-xl text-sm font-semibold"
                  placeholder="0.00"
                />
              </div>
              <button

      ...
      <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 py-6 md:py-8">
        <div className="mb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-5 py-2.5 bg-[#0071E3] text-white rounded-xl text-sm font-semibold hover:bg-[#0077ED] active:scale-95 transition-all shadow-sm"
          >
        ...
        {isLoading ? (
          ...
          <div className="py-24 flex flex-col items-center gap-4 bg-white rounded-3xl border border-dashed border-[#D2D2D7]">
            ...
            <button
              onClick={() => setIsModalOpen(true)}
              className="mt-2 text-[#0071E3] text-sm font-semibold hover:underline"
            >

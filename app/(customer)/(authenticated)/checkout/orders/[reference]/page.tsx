            ...
            <div
              className={`p-4 rounded-xl text-sm text-center font-medium ${
                paymentMessage.includes("Successful")
                  ...
                  : "bg-blue-50 text-[#0071E3] animate-pulse"
              }`}
            >
              {paymentMessage}
            </div>
              ...
              {({ errors, touched }) => (
                <Form className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-[#0071E3] hover:bg-[#0071E3]/90 text-white font-medium py-3.5 rounded-xl transition-colors flex justify-center items-center gap-2 disabled:opacity-50"
                  >
                    {loading ? (
